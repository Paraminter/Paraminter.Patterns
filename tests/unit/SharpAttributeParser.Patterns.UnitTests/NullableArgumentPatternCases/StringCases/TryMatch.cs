namespace SharpAttributeParser.Patterns.NullableArgumentPatternCases.StringCases;
...
{
    private static PatternMatchResult<string?> Target(IArgumentPattern<string?> pattern, object? argument) => pattern.TryMatch(argument);
