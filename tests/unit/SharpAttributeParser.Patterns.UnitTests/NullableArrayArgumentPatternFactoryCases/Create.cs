...
{
    private static IArgumentPattern<TElement[]?> Target<TElement>(INullableArrayArgumentPatternFactory factory, IArgumentPattern<TElement> elementPattern) => factory.Create(elementPattern);
