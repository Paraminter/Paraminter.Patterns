namespace SharpAttributeParser.Patterns.DelegatedArgumentPatternCases.EnumCases;
...
public sealed class TryMatch
{
    ...
    [AssertionMethod]
    private static void ResultsInMatch<TEnum>(TEnum expected, object? argument) where TEnum : Enum
    {
    ...
    [AssertionMethod]
    private static void ResultsInError<TEnum>(object? argument) where TEnum : Enum
    {
        var context = PatternContext<TEnum>.Create();
