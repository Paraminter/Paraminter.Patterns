...
public sealed class TypeArgumentPatternFactoryProvider : ITypeArgumentPatternFactoryProvider
{
    ...
    /// <param name="nonNullable">The factory of <see cref="IArgumentPattern{T}"/> matching non-nullable <see cref="Type"/> arguments.</param>
    /// <param name="nullable">The factory of <see cref="IArgumentPattern{T}"/> matching nullable <see cref="Type"/> arguments.</param>
