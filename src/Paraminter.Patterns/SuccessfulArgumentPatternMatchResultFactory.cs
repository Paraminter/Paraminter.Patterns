...
public sealed class SuccessfulArgumentPatternMatchResultFactory
    : ISuccessfulArgumentPatternMatchResultFactory
{
    ...
    IArgumentPatternMatchResult<TMatchedArgument> ISuccessfulArgumentPatternMatchResultFactory.Create<TMatchedArgument>(
        TMatchedArgument matchedArgument)
    {
        return new ArgumentPatternMatchResult<TMatchedArgument>(matchedArgument);
    }
