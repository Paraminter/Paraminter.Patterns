...
public sealed class ArgumentPatternMatchResultFactoryProvider
    : IArgumentPatternMatchResultFactoryProvider
{
    ...
    public ArgumentPatternMatchResultFactoryProvider(
