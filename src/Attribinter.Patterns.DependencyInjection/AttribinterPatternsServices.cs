...
/// <summary>Allows the services of <i>Attribinter.Patterns</i> to be registered with <see cref="IServiceCollection"/>.</summary>
public static class AttribinterPatternsServices
{
    /// <summary>Registers the services of <i>Attribinter.Patterns</i> with the provided <see cref="IServiceCollection"/>.</summary>
